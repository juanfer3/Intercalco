...
class TotalesFormulaControllerTest < ActionDispatch::IntegrationTest
  setup do
    @total_formula = totales_formula(:one)
  end

  test "should get index" do
    get totales_formula_url
  ...
  test "should create total_formula" do
    assert_difference('TotalFormula.count') do
      post totales_formula_url, params: { total_formula: { estado: @total_formula.estado, formula_tinta_id: @total_formula.formula_tinta_id, total: @total_formula.total } }
    end
  ...
  test "should destroy total_formula" do
    ...
    assert_redirected_to totales_formula_url
  end
end
