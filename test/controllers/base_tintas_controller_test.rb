...
class BaseTintasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create base_tinta" do
    assert_difference('BaseTinta.count') do
      post base_tintas_url, params: { base_tinta: { codigo: @base_tinta.codigo, descripcion_base: @base_tinta.descripcion_base, estado: @base_tinta.estado, linea_tinta_id: @base_tinta.linea_tinta_id } }
    end
  ...
  test "should update base_tinta" do
    patch base_tinta_url(@base_tinta), params: { base_tinta: { codigo: @base_tinta.codigo, descripcion_base: @base_tinta.descripcion_base, estado: @base_tinta.estado, linea_tinta_id: @base_tinta.linea_tinta_id } }
