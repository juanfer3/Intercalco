class TintasController < ApplicationController
  ...
  private
    ...
    def tinta_params
      params.require(:tinta).permit(:codigo, :pantone, :malla_id, :producto_id, :tipo_de_unidad, :cantida, :estado,
      formula_tintas_attributes:[:tinta_id, :base_tinta_id, :cantidad, :estado])
    end
end
