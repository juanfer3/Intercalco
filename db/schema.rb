...
ActiveRecord::Schema.define(version: 20171113175334) do

  create_table "base_tintas", force: :cascade do |t|
    t.string "codigo"
    t.integer "linea_tinta_id"
    t.text "descripcion_base"
    t.boolean "estado"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["linea_tinta_id"], name: "index_base_tintas_on_linea_tinta_id"
  end
  ...
  create_table "lineas_tinta", force: :cascade do |t|
  ...
  create_table "totales_formula", force: :cascade do |t|
    t.integer "formula_tinta_id"
    t.float "total"
    t.boolean "estado"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["formula_tinta_id"], name: "index_totales_formula_on_formula_tinta_id"
  end
